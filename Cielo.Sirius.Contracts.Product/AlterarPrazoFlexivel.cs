...
namespace Cielo.Sirius.Contracts.AlterarPrazoFlexivel
{
    [DataContract]
    public class AlterarPrazoFlexivelRequest : RequestBase
    {
    ...
    [DataContract]
    public class AlterarPrazoFlexivelResponse : ResponseBase
    {
        [DataMember]
