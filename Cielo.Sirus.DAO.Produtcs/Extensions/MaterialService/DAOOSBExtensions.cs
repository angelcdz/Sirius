...
namespace Cielo.Sirius.DAO.Products.Extensions.MaterialService
{
    using Cielo.Sirius.DAO.Products.MaterialService;
...
namespace Cielo.Sirius.DAO.Products.WR.Material.Extensions
{
    public static class DAOOSBExtensions
    {
        public static CieloSoapHeaderType GetSoapHeader<RequestType, ResponseType>(this DAOOSBBase<RequestType, ResponseType> dao)
