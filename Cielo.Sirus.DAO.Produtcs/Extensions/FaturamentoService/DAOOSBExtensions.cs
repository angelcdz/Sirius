...
namespace Cielo.Sirius.DAO.Products.Extensions.FaturamentoService
{
    using Cielo.Sirius.DAO.Products.FaturamentoService;
...
namespace Cielo.Sirius.DAO.Products.WR.Faturamento.Extensions
{
    public static class DAOOSBExtensions
    {
        public static CieloSoapHeaderType GetSoapHeader<RequestType, ResponseType>(this DAOOSBBase<RequestType, ResponseType> dao)
