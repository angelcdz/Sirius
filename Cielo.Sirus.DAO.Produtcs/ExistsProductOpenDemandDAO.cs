...
{
    public class ExistsProductOpenDemandDAO : DAOCRMBase<ExistsProductOpenDemandRequest, ExistsProductOpenDemandResponse>
    {
        protected override ExistsProductOpenDemandResponse GetData(ExistsProductOpenDemandRequest requestData)
        {
            ExistsProductOpenDemandResponse responseData = null;
            ...
            responseData = new ExistsProductOpenDemandResponse();
            ...
            foreach (var item in requestProducts.Entities)
            {
                ...
                {
                    var productWithDemand = new ExistsProductOpenDemandDTO();
