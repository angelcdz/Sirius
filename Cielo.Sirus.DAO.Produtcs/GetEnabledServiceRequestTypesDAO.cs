...
{
    public class GetEnabledServiceRequestTypesDAO : DAOCRMBase<GetEnabledServiceRequestTypesRequest, GetEnabledServiceRequestTypesResponse>
    {
        protected override GetEnabledServiceRequestTypesResponse GetData(GetEnabledServiceRequestTypesRequest requestData)
        {
            GetEnabledServiceRequestTypesResponse responseData = null;
            ...
            if (requestData.UserId != null && requestData.UserId != Guid.Empty)
            {
                ...
                responseData = new GetEnabledServiceRequestTypesResponse();
                responseData.ServiceRequestTypes = new List<GetEnabledServiceRequestTypesDTO>();
                GetEnabledServiceRequestTypesDTO serviceRequestType = null;

                foreach (var item in serviceRequestTypes.Entities)
                {
                    serviceRequestType = new GetEnabledServiceRequestTypesDTO();
