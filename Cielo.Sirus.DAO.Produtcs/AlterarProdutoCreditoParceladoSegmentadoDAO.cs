...
{
    public class AlterarProdutoCreditoParceladoSegmentadoDAO : DAOOSBBase<AlterarProdutoCreditoParceladoSegmentadoRequest, AlterarProdutoCreditoParceladoSegmentadoResponse>
    {
        protected override AlterarProdutoCreditoParceladoSegmentadoResponse GetData(AlterarProdutoCreditoParceladoSegmentadoRequest requestData)
        {
            var response = new AlterarProdutoCreditoParceladoSegmentadoResponse();
            ...
            foreach (var faixa in requestData.Faixas)
            {
                var faixaTaxaRequest = new FaixaTaxaSegmentado1();

                faixaTaxaRequest.codigoFaixa = faixa.CodigoFaixa;
                faixaTaxaRequest.numeroFinalParcelaFaixa = faixa.NumeroFinalParcelaFaixa;
                faixaTaxaRequest.numeroInicialParcelaFaixa = faixa.NumeroInicialParcelaFaixa;
                faixaTaxaRequest.percentualTaxaFaixa = faixa.PercentualTaxaFaixa;
