...
{
    class NonElegibleProductTaxesDetailsViewModel : ViewModelBase
    {
        #region Constants
        ...
        private Logger _logger = Logger.LoggerFor<NonElegibleProductTaxesDetailsViewModel>();
        ...
        private void CheckNonElegibleProductDetails()
        {
            ...
            else
            {
                ...
                ErrorId = Trace.CorrelationManager.ActivityId.ToString("D", CultureInfo.InvariantCulture);
                _logger.LogError("TechnicalError occurred while executing: 'NonElegibleProductDetailsModel'");
            }
        }
