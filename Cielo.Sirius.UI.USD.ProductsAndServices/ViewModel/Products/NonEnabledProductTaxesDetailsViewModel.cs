...
{
    class NonEnabledProductTaxesDetailsViewModel : ViewModelBase
    {
        #region Constants
        ...
        private NonEnabledProductDetailsModel _productDetailsModel;

        private Logger _logger = Logger.LoggerFor<NonEnabledProductTaxesDetailsViewModel>();
        ...
        public override void PreInitialize(System.Collections.Generic.Dictionary<string, object> navegationParams_)
        {
            ...
            if (LoadNonEnabledProductDetails())
            {
                CheckNonEnabledProducDetails();
            }
        ...
        private bool LoadNonEnabledProductDetails()
        {
            _productDetailsModel = new NonEnabledProductDetailsModel();
            ...
            ConsultarDetalheProdutoElegivelClienteRequest requestNonEnabledeProductDetails = new ConsultarDetalheProdutoElegivelClienteRequest();
            requestNonEnabledeProductDetails.CodigoProduto = _codigoProduto;
            requestNonEnabledeProductDetails.CodigoCliente = clientIdNumber;
            _productDetailsModel.Request = requestNonEnabledeProductDetails;

            _productDetailsModel.Execute();
            return true;
        }
