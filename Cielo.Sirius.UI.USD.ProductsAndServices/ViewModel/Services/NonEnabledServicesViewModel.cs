...
{
    class NonEnabledServicesViewModel : ViewModelBase
    {
        #region Constants
                ...
                if (_serviceSelectedCommand == null)
                {
                    _serviceSelectedCommand = new RelayCommand(
                        param =>
                        {
                            ...
                            Navegate("NonEnabledServiceDetails", "ProductsAndServicesMainRegion", "", paramsDic);
                        },
                        param => true
                    );
                }
        ...
        private void LoadServicesCommandMethod()
        {
            ...
            var servicesModel = new NonEnabledServicesModel();
            servicesModel.Request = new ConsultarServicoElegivelClienteRequest();
        ...
        public class Service
        {
            ...
            public ConsultarServicoClienteElegivelServicoDTO ServiceDTO { get; set; }
        }
