...
namespace Cielo.Sirius.DynamicsCRM.Plugins
{
    public class PluginBase : IPlugin
    {
        ...
        private LocalPluginContext localcontext;
        ...
        protected T GetEntityParameter<T>(string parameterName) where T : IExtensibleDataObject
        {
            T returnValue = (T)localcontext.PluginExecutionContext.InputParameters[parameterName];

            return returnValue;
        }
        /// <summary>
        /// Método para recuperar registros do CRM, no formato "Entity", utilizando o id do registro.
        /// </summary>
        /// <param name="entityLogicalName"> Nome lógico da entidade</param>
        /// <param name="id">Id da entidade</param>
        /// <param name="attributes">Columnset com os atributos desejados da entidade</param>
        /// <returns></returns>
        protected Entity GetEntityById(string entityLogicalName, Guid id, ColumnSet attributes)
        {
            Entity returnValue = null;

            returnValue = (Entity)localcontext.OrganizationService.Retrieve(entityLogicalName, id, attributes);
